...
const RAW_CONFIG = {   "company": {     "name": "Splunk",     "role": "Leader, Global Platform Specialists, GTM Strategy & Programs"   },   "challenges": [     {       "title": "Developing Long-Term Platform GTM Strategy",       "approach": [         "Design GTM architecture and playbook for platform expansion",         "Implement AI-first execution across multiple channels",         "Focus on forecasting and pipeline hygiene for long-term success"       ]     },     {       "title": "Driving Synergy with Cisco's Sales Force",       "approach": [         "Develop joint GTM strategies for synergy with Cisco",         "Implement AI-driven voice cycles for effective collaboration",         "Enhance RevOps automation for streamlined processes"       ]     },     {       "title": "Scaling Growth Through Joint GTM Strategies",       "approach": [         "Operationalize repeatable outbound motions to increase meetings per week",         "Establish guardrails for increased efficiency and reduced opt-outs",         "Deliver operator-grade visibility through dashboards and playbooks"       ]     }   ],   "skills": [     "GTM architecture and playbook design",     "AI-first execution across phone, email, and LinkedIn",     "Forecast, pipeline hygiene, and RevOps automation"   ],   "trackRecord": [     "Seven-figure pipeline created within months",     "38% meeting-to-client conversion rate sustained",     "$431K in early pipeline generated by testing GTM motions before POC adoption"   ],   "icp": {     "demographics": [       "Enterprise, across security, IT, and engineering functions"     ],     "messagePillars": [       "Risk reduction and compliance",       "Scalability and reliability",       "Integration fit and data quality"     ],     "channelFocus": [       "ABM with executive outreach",       "Partner co-sell and marketplace attach"     ],     "riskMitigation": [       "Legal or compliance objections",       "Data access and integration risk"     ]   },   "theme": {     "primary": "#F99E1C",     "secondary": "#EF4A37",     "accent": "#CE006F"   },   "sendsparkUrl": "https://sendspark.com/share/mr0cs3yt1hw20x5khyfbr45p60fyg2vs" } as unknown as GTMPageConfig;
