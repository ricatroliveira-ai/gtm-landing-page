...
return ( <div className="min-h-screen bg-background"> <section className="py-20 px-4 text-center" style={heroStyle}> <div className="max-w-6xl mx-auto"> <h1 className="text-5xl font-black leading-tight tracking-tight mb-6">
...
onClick={() => window\.open('[https://www.linkedin.com/in/ricatroliveira')}](https://www.linkedin.com/in/ricatroliveira'%29})
