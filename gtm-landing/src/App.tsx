...
// NEW helpers for requested color changes
...
A GTM leader who ships <span style={revenueSpanStyle}>revenue</span>, not decks. </h1>
  ...
  {/* Numbers section: BG White, subheader + icons + stats in Accent */}
  ...
  {/* 30-60-90: section BG Accent, cards White, text Black, icons Accent, big numbers Accent */}
  ...
  {/* ICP section: BG White, titles & icons Accent, text Black */}
  <section className="py-20 px-4" style={whiteBg}>
    <div className="max-w-4xl mx-auto">
