...
const RAW_CONFIG = {   "company": {     "name": "Harmonic Inc",     "role": "Telco Fiber Go-To-Market (GTM) Senior Manager"   },   "challenges": [     {       "title": "Drive Growth in Fiber Business",       "approach": [         "Design tailored GTM architecture for Fiber services",         "Implement AI-first execution for targeted outreach",         "Utilize forecasting and pipeline hygiene for growth"       ]     },     {       "title": "Expand Market Engagement with Telcos",       "approach": [         "Craft targeted GTM strategies for Telco segment",         "Execute AI-driven voice cycles for personalized outreach",         "Optimize RevOps automation for market expansion"       ]     },     {       "title": "Develop Strategic Relationships with Stakeholders",       "approach": [         "Deploy persona-based dynamic copy for relationship building",         "Design strategic GTM frameworks for stakeholder engagement",         "Track and optimize KPIs for relationship management"       ]     }   ],   "skills": [     "GTM architecture and playbook design",     "AI-first execution across phone, email, and LinkedIn",     "Forecast, pipeline hygiene, and RevOps automation"   ],   "trackRecord": [     "$1.2M in qualified pipeline in 4 months",     "38% meeting-to-client conversion rate",     "14% to 31% reply-to-meeting conversion"   ],   "icp": {     "demographics": [       "Enterprise, cross-functional buying committee including CTO and IT leaders"     ],     "messagePillars": [       "Scalability and reliability",       "Integration fit and data quality",       "Personalization and AI leverage"     ],     "channelFocus": [       "Outbound POC to prove value fast",       "ABM with executive outreach"     ],     "riskMitigation": [       "Forecast or ROI skepticism",       "Data access and integration risk"     ]   },   "theme": {     "primary": "#03243D",     "secondary": "#25B0D9",     "accent": "#03243D"   },   "sendsparkUrl": "https://sendspark.com/share/2k03vpgck2wha9mogde7f7il0fpo9wkt" } as unknown as GTMPageConfig;
