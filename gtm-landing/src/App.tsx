...
const RAW_CONFIG = {   "company": {     "name": "Talentful",     "role": "Senior GTM Sourcer"   },   "challenges": [     {       "title": "Attracting Top Talent in Competitive Market",       "approach": [         "Craft persona-based dynamic copy for job listings",         "Implement AI-driven voice cycles to increase applicant conversion rates",         "Design and deploy trigger-based sequences for candidate engagement"       ]     },     {       "title": "Deeply Embedding in Client Cultures",       "approach": [         "Build ICPs and sequenced outreach to understand client nuances",         "Apply vertical-specific intros for deeper client connection",         "Create agentic revenue systems to capture and score client signals"       ]     },     {       "title": "Partnering with Senior Stakeholders Effectively",       "approach": [         "Run fast POC cycles with AI agents for quick executive buy-in",         "Develop and execute an operator-grade GTM playbook for senior stakeholders",         "Track and optimize KPIs to align with executive goals"       ]     }   ],   "skills": [     "GTM architecture and playbook design",     "AI-first execution across phone, email, and LinkedIn",     "Forecast, pipeline hygiene, and RevOps automation"   ],   "trackRecord": [     "31% reply-to-meeting conversion (up from 14%)",     "33% SQL rate (up from 22%)"   ],   "icp": {     "demographics": [       "SMB focusing on talent acquisition and HR solutions"     ],     "messagePillars": [       "Speed to value and time to first outcome",       "Scalability and reliability",       "Integration fit and data quality"     ],     "channelFocus": [       "Outbound POC to prove value fast",       "Community and developer relations for dev-led products"     ],     "riskMitigation": [       "Adoption risk - may need manager-first enablement and usage goals",       "Forecast or ROI skepticism - consider weekly scorecard and exit criteria"     ]   },   "theme": {     "primary": "#F46845",     "secondary": "#5F3F3F",     "accent": "#F46845"   },   "sendsparkUrl": "https://sendspark.com/share/mqm9wqz3oddzwrwffe3vjmry4c8hu90r" } as unknown as GTMPageConfig;
